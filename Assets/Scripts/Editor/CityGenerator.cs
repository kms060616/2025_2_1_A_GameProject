...
public class CityGenerator : EditorWindow          //unity 에디터 창을 만드는 클래스
{
    ...
    private int gridSizeZ = 10;                   //도시 세로크기
    private float buildingSpacing = 15;           //건물 사이간격
    private float roadWidth = 5f;                 //도로폭
    private bool makeStatic = true;               //생성되는 오브젝트를 static으로 만들지 여부

    [MenuItem("Tools/City Generator")]           //유니티 상단 메뉴에 버튼추가

    public static void ShowWindow()
    {
        GetWindow<CityGenerator>("City Generator");       //에디터창열기
    }
    ...
    private void OnGUI()
    {
        ...
        buildingSpacing = EditorGUILayout.FloatField("Building Space", buildingSpacing);
    ...
    private void GenerateCity()
    {
        ...
        GameObject buildingsParent = new GameObject("Building");
